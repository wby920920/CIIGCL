...
class GCNMOdel(MessagePassing):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        self.gcn1 = GCNConv(400, out_dim)
        self.lin1 = nn.Linear(in_dim, out_dim).cuda()
...
class GNN_imp_estimator(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK="last", drop_ratio=0):
        ...
        self.gnns.append(GCNMOdel(400, 128))
        self.gnns.append(GCNMOdel(128, 64))
        self.gnns.append(GCNMOdel(64, 32))
    ...
    def forward(self, *argv):
        ...
        for layer in range(len(self.gnns)):
            ...
            print(x.shape)
            print('------------------------')
            h = self.gnns[0](x, edge_index, edge_attr)
